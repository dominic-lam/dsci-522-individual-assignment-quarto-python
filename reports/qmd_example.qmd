...
editor: source
website:
    base-url: /dsci-522-individual-assignment-quarto-python
---
...
![](../results/horse_pops_plot.png){#fig-horse_pops_plot width=70% fig-pos="H"}

@fig-horse_pops_plot: Horse populations for all provinces in Canada from 1906 - 1972.
...
We present the standard deviations in @tbl-std_hist_horse_pop_ca_province.

```{python}
#| label: tbl-std_hist_horse_pop_ca_province
...
Additionally, note that in @tbl-std_hist_horse_pop_ca_province we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.

![](../results/horse_pops_plot_largest_sd.png){#fig-horse_pops_plot_largest_sd width=65% fig-pos="H"}

@fig-horse_pops_plot_largest_sd: Horse populations for the province with the largest standard deviation
